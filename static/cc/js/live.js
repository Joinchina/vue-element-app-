$(function () {
    ...
    $(".viewall").click(function () {
        ...
        if (wchatflag) {
            ...
            $('#chat-list li[uid]').hide();
            $('.c-chat').hide();
            $(this).addClass('viewall-active');
            $(this).attr('title', '只显示我的聊天信息');

        } else {
            $('#chat-list li').show();
            $('#chat-list li[uid]').show();
            $(this).removeClass('viewall-active');
            $(this).attr('title', '显示所有聊天信息');
...
DWLive.onRoomSetting = function (data) {
    ...
    console.log("是否允许语音通话", data.allow_speak_interaction);
    // 允许语音通话
    if (data.allow_speak_interaction == 'true') {
        console.log("允许语音通话", data.allow_speak_interaction);
        $audioInteraction.show();
        $videoInteraction.show();
    } else {

        console.log("断开语音通话", data.allow_speak_interaction);
        // 断开语音通话
        DWLive.hangupInteraction();
