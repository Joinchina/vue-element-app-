let barrageWall = {
    ...
    upWall: function(img, user, txt,messageType) {
        ...
        if(messageType=="horn"){
            ...
            elem = $('<div></div>').addClass('barrageItem administrator').css({"top":this.lastElem * 38 +10 + "px","color":"#fff"}).html("<img src='" + img + "' alt=''/>" + '<em style="color:#98FF2D">' +user + '：</em>'+ txt).appendTo(this.container);
