...
class signalClient{
	constructor(options){
        ...
        this.account = this.userName + "_" + this.uid;
         //channel类
        this.channel = null;
        //初始化session类
		this.session = null;
    ...
    initCall(call,options){
        ...
        call.onInviteReceivedByPeer = function(extra){
            if(options){
                _this.sendServerMsg(account,"student_channelInviteUser2");
        ...
        call.onInviteAcceptedByPeer = function(extra){
            if(options){
                _this.sendServerMsg(account,"student_channelInviteAccept");
        ...
        call.onInviteEndByMyself = function(extra){
            if(options){
                _this.sendServerMsg(account,"student_channelInviteEnd");
