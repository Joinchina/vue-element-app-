	...
	<div class="j-homework">
		<section class="item" v-for="(items,index) in item" :key="index">
			...
			<section v-show="items.status=='ATTEND'">
				...
				<div class="bottom">
					<router-link :to="{path:'/Refl/refledit',query:{activityId:items.id,status:items.status}}" class="btn-homework" >去参与</router-link> 
				</div>
			...
			<section v-show="items.status=='NOTSTARTE'">
				...
				<div class="bottom">
					<router-link :to="{path:'/Refl/refldetail',query:{activityId:items.id,status:items.status}}" class="btn-modify" >查看</router-link>
				</div>
